...
class UploadHandler
{
    ...
    public function __construct($param_name, $options = null, $initialize = true, $error_messages = null) {
        $this->response = array();
        $this->options = array(
            'script_url' => $this->get_full_url().'/'.$this->basename($this->get_server_var('SCRIPT_NAME')),
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/assets/temp_files/',
            'upload_url' => $this->get_full_url().'/assets/temp_files/',
