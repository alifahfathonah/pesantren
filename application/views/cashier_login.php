...
<body class="page-md login">
    ...
    <div class="content">
        ...
        <?= form_open('cashier-login', ['class' => 'login-form']) ?>
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">Password</label>
            <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="Cashier Password" name="password" />
        </div>
        <input type="hidden" name="login" value="Login" />
        <div class="form-actions">
            <input type="submit" class="btn btn-default btn-block uppercase" value="Login" />
        </div>
        <!-- <div class="form-actions">
      <div class="pull-left">
