        ...
        <script src="<?= base_url('assets/metronic') ?>/assets/layouts/layout4/scripts/layout.min.js" type="text/javascript"></script>
        <script src="<?= base_url('assets/metronic') ?>/assets/layouts/layout4/scripts/demo.min.js" type="text/javascript"></script>
