...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>404 Page <?= $title . ' | ' . $global_title ?> </title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1" name="viewport" />
        <meta content="Preview page of Metronic Admin Theme #4 for 404 page option 2" name="description" />
        ...
        <link href="<?= base_url('assets/metronic') ?>/assets/pages/css/error.min.css" rel="stylesheet" type="text/css" />
            ...
            <div class="col-md-12 page-404">
                ...
                <div class="details">
                    ...
                    <p> We can not find the page you're looking for.
                        <br/>
                        <a href="<?= base_url('') ?>"> Return home </a> or try the search bar below. </p>
                    <form action="#">
